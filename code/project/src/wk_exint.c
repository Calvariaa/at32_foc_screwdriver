...
void wk_exint_config(void)
{
  ...
  gpio_init_struct.gpio_pins = ENC_A_PIN;
  gpio_init_struct.gpio_pull = GPIO_PULL_NONE;
  gpio_init(ENC_A_GPIO_PORT, &gpio_init_struct);

  scfg_exint_line_config(SCFG_PORT_SOURCE_GPIOA, SCFG_PINS_SOURCE2);
  ...
  gpio_default_para_init(&gpio_init_struct);
  gpio_init_struct.gpio_mode = GPIO_MODE_INPUT;
  gpio_init_struct.gpio_pins = ENC_B_PIN;
  gpio_init_struct.gpio_pull = GPIO_PULL_NONE;
  gpio_init(ENC_B_GPIO_PORT, &gpio_init_struct);
